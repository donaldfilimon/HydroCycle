...
| Evidence rails | Provenance and quality remain visible beside conclusions | Summary separates eligible selected Test Run datasets from the global literature ledger and current model assumptions; Workbench retains measured/literature/assumption tabs and applicability notes | Pass |
